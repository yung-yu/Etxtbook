package com.android.ebook.util;
...
public class Log {
    ...
    private static final String TAG = "com.org.ebook";
    private static final String LOG_FILE = "debug_%g.log";
    private static final String LOG_FILEPATH = "/ebook/log/";
    ...
    public static String getLogFilePath(){
     ...
     public synchronized static Logger getLogger(){
         if(logger==null){
             logger = Logger.getLogger("com.org.ebook");
             try {
